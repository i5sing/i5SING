...
import { I5singComment, I5singMovie, I5singResponse } from "../interfaces/i5sing";
import { COMMENT, DISCOVERY_MOVIE, LOVE, MOVIE, MOVIES, NETWORK_STATUS } from "../constants/action-types.constant";
import { SET, UPDATE_PROPERTY } from "../constants/actions.constant";
import { IComment, IMovie } from "../interfaces";
import { NetworkAction } from "./network.action";
import { MOVIE_COMMENT, MOVIE_REPLY } from "../constants/network-status.constant";
